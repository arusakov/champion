...
urlpatterns = [
    ...
    path('groups/<group_id>/delete/', views.GroupDelete.as_view(), name='group-delete'),
    path('groups/<group_id>/lessons/create/', views.GroupLessonCreate.as_view(), name='lesson-create'),
    path('groups/<group_id>/lessons/<lesson_id>/delete/', views.GroupLessonDelete.as_view(), name='lesson-delete'),
]
